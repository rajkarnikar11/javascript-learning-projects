...
//input images //
const slider1 = new Carousel();
slider1.createCarousel("./assets/slide1.jpg");
const slider2 = new Carousel();
slider2.createCarousel("./assets/slide2.jpg");
const slider3 = new Carousel();
slider3.createCarousel("./assets/slide3.jpg");
const slider4 = new Carousel();
slider4.createCarousel("./assets/slide4.jpg");
